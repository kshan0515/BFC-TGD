  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-2xl">
      <div className="flex items-center justify-between mb-8">
        <h2 className="text-2xl font-black text-zinc-900 dark:text-white">2026 경기 일정</h2>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="text-center min-w-[50px]">
                    <p className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase">{month}월</p>
                    <p className="text-2xl font-black text-zinc-900 dark:text-white leading-none">{day}</p>
                    <p className="text-[10px] font-bold text-zinc-500 dark:text-zinc-400">({weekday})</p>
                  </div>
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs font-bold text-zinc-400 dark:text-zinc-500">{time}</span>
                    </div>
                    <h3 className="text-lg font-black text-zinc-900 dark:text-white">
                      부천 <span className="text-zinc-300 dark:text-zinc-700 mx-1">vs</span> {match.opponent}
                    </h3>
                  </div>
                </div>
